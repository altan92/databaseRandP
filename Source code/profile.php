...
echo "<div class='main'><div class='main' style='color:white; margin-right:30px; '><h3>Your Account Information</h3>";
$user=$_SESSION['user'];
...
<input type='submit' class='myButton3' value='Add Interest!' />  
</form>
</div>
_END;
...
<table class="flat-table flat-table-1" border="2" style="color:white;">
...
echo <<<_END
<input type='submit' class='myButton3' value='See Question data' />  
</form>
_END;
